...
export function Buangan({ articles }) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article, index) => (
                <article
                    key={article.id}
                    className="group relative bg-white/60 backdrop-blur-sm rounded-2xl shadow hover:bg-white/80 hover:shadow-xl transition-all duration-500 border border-white/20 flex flex-col h-full overflow-hidden"
                    style={{
